...
> Άνοιγμα αυτής της σελίδας στο [https://playtpe.github.io/clap-lights/](https://playtpe.github.io/clap-lights/)
...
* αναζήτηση για **https://github.com/playtpe/clap-lights** και εισαγωγή
...
* επικολλήστε **https://github.com/playtpe/clap-lights** και κάντε κλικ στην εισαγωγή
